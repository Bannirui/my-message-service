...
import com.github.bannirui.mms.client.statistic.kafka.KafkaConsumerInfo;
import com.github.bannirui.mms.client.statistic.kafka.KafkaConsumerStatistics;
        ...
        try {
            ...
            for (ObjectInstance instance : objectInstances) {
                ...
                if (!StringUtils.isBlank(clientIdName) && clientIdName.contains("--")) {
                    ...
                    kafkaConsumerInfo.setIp(MmsConst.MMS_IP);
