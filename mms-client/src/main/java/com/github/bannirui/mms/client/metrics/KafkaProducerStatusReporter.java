...
import com.github.bannirui.mms.client.statistic.kafka.KafkaProducerInfo;
import com.github.bannirui.mms.client.statistic.kafka.KafkaProducerStatistics;
        ...
        try {
            ...
            for (ObjectInstance instance : objectInstances) {
                ...
                if (!StringUtils.isBlank(clientIdName) && clientIdName.contains("--")) {
                    ...
                    kafkaProducerInfo.setIp(MmsConst.MMS_IP);
             ...
             Mms.sendOneway(MmsConst.Measurement.STATISTIC_TOPIC_PRODUCER_INFO, new SimpleMessage(JSON.toJSONBytes(producerStatistics, new SerializerFeature[0])));
        } catch (Exception e) {
